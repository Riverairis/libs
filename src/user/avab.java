 ...
 * @author Hp
 */
public class avab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(650, 80, 23, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(avab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
